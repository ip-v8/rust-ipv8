...
impl<'de> Deserialize<'de> for DefaultHeader {
        ...
        D: Deserializer<'de>,
    {
        ...
        let mid_hash = [
            ...
            payload_temporary.8,
            payload_temporary.9,
            payload_temporary.10,
            payload_temporary.11,
            payload_temporary.12,
            payload_temporary.13,
            payload_temporary.14,
            payload_temporary.15,
            payload_temporary.16,
            payload_temporary.17,
            payload_temporary.18,
            payload_temporary.19,
            payload_temporary.20,
...
mod tests {
    ...
    fn integration_test_creation() {
        ...
        assert_eq!(
            ...
            bincode::config()
                .big_endian()
                .deserialize(&bincode::config().big_endian().serialize(&i).unwrap())
                .unwrap()
        );
    }
}
